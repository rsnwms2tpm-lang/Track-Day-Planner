(()=>{
 ...
 const css=document.createElement('style');css.textContent='.tdh-weather{margin-top:22px;padding-top:18px;border-top:1px solid rgba(255,255,255,.12)}.tdh-weather-title{font-size:10px;font-weight:950;letter-spacing:.16em;color:#72df9e}.tdh-weather-title span{color:#7f8995;margin-left:5px}.tdh-weather-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:11px}.tdh-weather-session{display:flex;align-items:center;gap:9px;padding:10px 11px;border:1px solid #303941;border-radius:14px;background:rgba(8,12,14,.55)}.tdh-weather-icon{font-size:25px}.tdh-weather-session div{min-width:0}.tdh-weather-session small,.tdh-weather-session strong,.tdh-weather-session div>span{display:block}.tdh-weather-session small{font-size:8px;font-weight:950;letter-spacing:.13em;color:#8f9aa5}.tdh-weather-session strong{font-size:12px;margin-top:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.tdh-weather-session div>span{font-size:9px;color:#89949d;margin-top:2px}@media(max-width:390px){.tdh-weather-grid{grid-template-columns:1fr}.tdh-weather{margin-top:18px}}';document.head.appendChild(css);
