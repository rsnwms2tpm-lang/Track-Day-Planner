...
function saveSession(){localStorage.setItem('tdp-session',JSON.stringify(session));window.session=session;window.dispatchEvent(new CustomEvent('tdh:session-ready',{detail:session}))}
