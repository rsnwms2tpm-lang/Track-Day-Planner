(() => {
  ...
  style.textContent=`
    ...
    .departure-card.tdh-departure-saved .departure-head .eyebrow::after{content:'MEET & DEPARTURE';display:inline-block;font-size:1.17em!important;font-weight:700!important;letter-spacing:normal!important;color:#f4f5f7!important}
  ...
  function enhance(shell){
    ...
    const travelContent=travel.querySelector('[data-travel-content]');travelContent?.insertAdjacentHTML('beforeend','<section class="trip-mode-card"><span class="travel-navigation-title">NAVIGATION</span><h2>Let’s roll</h2><p class="muted">Pick the next stop and Waze will take it from here.</p><div class="travel-actions"><a class="travel-destination" data-waze-stay target="_blank" rel="noopener">Accommodation</a><a class="travel-destination" data-waze-track target="_blank" rel="noopener">Track</a></div></section>');
