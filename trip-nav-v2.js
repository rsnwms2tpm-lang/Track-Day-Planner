(() => {
  ...
  function enhance(shell){
    ...
    const travelContent=travel.querySelector('[data-travel-content]');travelContent?.insertAdjacentHTML('beforeend','<section class="trip-mode-card"><span class="eyebrow">🧭 NAVIGATION</span><h2>On the road</h2><p class="muted">Open the destination in Waze when the crew is ready to move.</p><div class="travel-actions"><a class="travel-destination" data-waze-stay target="_blank" rel="noopener">Accommodation</a><a class="travel-destination" data-waze-track target="_blank" rel="noopener">Track</a></div></section>');
